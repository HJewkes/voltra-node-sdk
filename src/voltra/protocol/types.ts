...
export interface TelemetryConfig {
   ...
   *
   * Generated by voltra-private's `buildParameterCatalog()` from the
   * `parameters/` registry. Optional for backward compat with
   * protocol-data versions older than Phase 2.5.
   */
...
/**
 * Single parameter entry in the generated catalog. Mirrors voltra-private's
 * `ParameterDefinition` minus the runtime `encode`/`decode` functions
 * (which can't be JSON-serialized through the base64 protocol-data
 * pipeline).
 */
